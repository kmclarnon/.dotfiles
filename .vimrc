...
" Settings to make coc work better
set hidden				" TextEdit might fail if hidden is not set
set updatetime=300			" Having longer updatetime (default is 4s) leads to noticable delays
set nowritebackup			" Really turn off backups
